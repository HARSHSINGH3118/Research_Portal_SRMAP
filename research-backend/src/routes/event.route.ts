 ...
 */
eventRouter.get("/:eventId/submissions", requireAuth(["coordinator"]), async (req, res) => {
  try {
 ...
 */
eventRouter.get("/reviewers/all", requireAuth(["coordinator"]), async (_req, res) => {
  try {
 ...
 */
eventRouter.get("/:eventId/assignments", requireAuth(["coordinator"]), async (_req, res) => {
  try {
